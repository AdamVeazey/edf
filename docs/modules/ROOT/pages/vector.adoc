...
:size_t_literal: https://en.cppreference.com/w/cpp/language/user_literal[user-defined literal] to get a std::size_t. See <<important_size_t>> Defined in {ref_edf_math}.
