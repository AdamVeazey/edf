...
----
include::{path_example_edf_stack_main_cpp}[tag=init]
include::{path_example_edf_stack_main_cpp}[tag=operation_top]
----

WARNING: Rename to peek for consistency with Queue. I also feel it gives a better picture of what it does, allows you to just peek, look, read, at the element you are likely to remove next using <<pop>>
