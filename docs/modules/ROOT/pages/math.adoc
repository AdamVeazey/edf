...
* xref:ROOT:math.adoc#nElements[]
* xref:ROOT:math.adoc#isPow2[]
* xref:ROOT:math.adoc#min[]
* xref:ROOT:math.adoc#max[]
* xref:ROOT:math.adoc#voltageDividerCalcVout[]
* xref:ROOT:math.adoc#voltageDividerCalcVin[]
* xref:ROOT:math.adoc#temperatureCtoF[]
* xref:ROOT:math.adoc#temperatureFtoC[]
// end::function_list[]
