...
NOTE: {ref_edf_math__uz} and {ref_edf_math_n_elements} loosely fit within this file. One could argue that {ref_edf_math__uz} is related to math. One could also argue that {ref_edf_math_n_elements} is a _calculation_ to find the number of elements within an array.

NOTE: Decided that a dedicated file for {ref_edf_math__uz} would create a temptation to make more user-defined literals. 
