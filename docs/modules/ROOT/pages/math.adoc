...
// tag::function_list[]
* xref:ROOT:math.adoc#uz[]
* xref:ROOT:math.adoc#n_elements[]
* xref:ROOT:math.adoc#is_pow_2[]
* xref:ROOT:math.adoc#min[]
* xref:ROOT:math.adoc#max[]
* xref:ROOT:math.adoc#voltage_divider_calc_v_out[]
* xref:ROOT:math.adoc#voltage_divider_calc_v_in[]
* xref:ROOT:math.adoc#temperature_c_to_f[]
* xref:ROOT:math.adoc#temperature_f_to_c[]
// end::function_list[]

[#uz]
== _uz
This is a user defined literal. The intended purpose of this is to be able to create an integer literal of type `std::size_t`. 
...
3. If there is no macro for the array size, you still can get a compile time constant value for the number of elements in that array using <<nElements>>.
